...
export const UNISWAP_V3_FACTORY = "0xcb2436774c3e191c85056d248ef4260ce5f27a9d";
export const UNISWAP_V3_POSITION_MANAGER = "0x743e03cceb4af2efa3cc76838f6e8b50b63f184c";
export const UNISWAP_V3_QUOTER_V2 = "0x5911cb3633e764939edc2d92b7e1ad375bb57649";
export const WOKB_ADDRESS = "0xe538905cf8410324e03a5a23c1c177a474d59b2b";
export const NATIVE_OKB_SENTINEL = "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee";
export const UNISWAP_NATIVE_TOKEN_ADDRESS = "0x0000000000000000000000000000000000000000";
export const FACTORY_DISCOVERY_FROM_BLOCK = 0n;
export const SWAP_ACTIVITY_LOOKBACK_BLOCKS = 1200n;
...
export const OFFICIAL_RANGE_WIDTHS = {
    stable: {
        conservative: 0.02,
        balanced: 0.01,
        aggressive: 0.005
...
export const RECOMMENDED_FEE_TIER_BY_ARCHETYPE = {
    stable: 100,
    correlated: 500,
    major: 3000,
    volatile: 10000
...
export const DISCOVERY_SYMBOL_QUERIES = ["WOKB", "USDC", "USDT", "XLAYER_USDT", "WETH", "WBTC"];
